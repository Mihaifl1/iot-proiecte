...
const I18N = {
  ro: {
    ...
    shopOrderOk: "Comanda a fost trimisă. Te contactăm în curând.",
    shopNone: "Niciun produs în această categorie.",
    shopBack: "← Proiecte IoT",
    shopMetaTitle: "Magazin IoT – componente ESP",
    ordersLink: "Comenzi",
    ordersTitle: "Comenzi primite",
    ordersLead: "Vezi comenzile date pe acest aparat. Ca să-ți vină și de pe telefoanele clienților, pune numărul WhatsApp în Manager → Magazin.",
    ordersEmpty: "Nicio comandă pe acest aparat.",
    ordersWhen: "Data",
    ordersClear: "Șterge lista de pe acest aparat",
    ordersHint: "Deschide: esp-proiecte.md/shop/#/comenzi",
  ...
  en: {
    ...
    shopOrderOk: "Order sent. We will contact you soon.",
    ...
    ordersLead: "Orders placed on this device. To get orders from customers’ phones, set your WhatsApp number in Manager → Shop.",
    ordersEmpty: "No orders on this device.",
    ordersWhen: "Date",
    ordersClear: "Clear list on this device",
    ordersHint: "Open: esp-proiecte.md/shop/#/comenzi",
    flashBadge: "USB flash",
  ...
  ru: {
    ...
    shopOrderOk: "Заказ отправлен. Мы свяжемся с вами.",
    ...
    ordersLead: "Заказы с этого устройства. Чтобы получать с телефонов клиентов, укажите WhatsApp в Manager → Магазин.",
    ordersEmpty: "На этом устройстве заказов нет.",
    ordersWhen: "Дата",
    ordersClear: "Очистить список на этом устройстве",
    ordersHint: "Откройте: esp-proiecte.md/shop/#/comenzi",
    flashBadge: "USB flash",
